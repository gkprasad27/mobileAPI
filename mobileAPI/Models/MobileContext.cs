...
namespace mobileAPI.Models
{
    public partial class MobileContext : DbContext
    {
        ...
        public virtual DbSet<TblDataConfig> TblDataConfig { get; set; }
        public virtual DbSet<TblForm> TblForm { get; set; }
        public virtual DbSet<TblFormPermission> TblFormPermission { get; set; }
        public virtual DbSet<TblRoles> TblRoles { get; set; }
        public virtual DbSet<TblTourBills> TblTourBills { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=.\\SQLEXPRESS;Database=Mobile;Integrated Security=true");
            }//Data Source=.\SQLEXPRESS;Database=Mobile;Integrated Security=true;
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<LeaveApplDetails>(entity =>
            {
                ...
                entity.Property(e => e.FromEvening)
                    .HasMaxLength(50)
                    .IsUnicode(false);

                entity.Property(e => e.FromMorning)
                    .HasMaxLength(50)
                    .IsUnicode(false);
                ...
                entity.Property(e => e.ToEvening)
                    .HasMaxLength(50)
                    .IsUnicode(false);

                entity.Property(e => e.ToMorning)
                    .HasMaxLength(50)
                    .IsUnicode(false);
            });
            ...
            modelBuilder.Entity<LeaveRequest>(entity =>
            {
                ...
                entity.Property(e => e.FromEvening)
                    .HasColumnName("fromEvening")
                    .HasMaxLength(50)
                    .IsUnicode(false);

                entity.Property(e => e.FromMornig)
                    .HasColumnName("fromMornig")
                    .HasMaxLength(50)
                    .IsUnicode(false);
                ...
                entity.Property(e => e.ToEvening)
                    .HasColumnName("toEvening")
                    .HasMaxLength(50)
                    .IsUnicode(false);

                entity.Property(e => e.ToMorning)
                    .HasColumnName("toMorning")
                    .HasMaxLength(50)
                    .IsUnicode(false);
            ...
            modelBuilder.Entity<TblDataConfig>(entity =>
            {
                entity.ToTable("tbl_dataConfig");
            ...
            modelBuilder.Entity<TblFormPermission>(entity =>
            {
                entity.ToTable("tbl_formPermission");
            ...
            modelBuilder.Entity<TblTourBills>(entity =>
            {
                entity.ToTable("tbl_tourBills");
                ...
                entity.Property(e => e.ApprovedPersion)
                    .HasMaxLength(10)
                    .IsFixedLength();
                ...
                entity.Property(e => e.RecommendedPersion)
                    .HasMaxLength(10)
                    .IsFixedLength();
            ...
            modelBuilder.Entity<TourAdvance>(entity =>
            {
                ...
                entity.Property(e => e.FromJourneyDate)
                    .HasColumnName("FromJourney_Date")
                    .HasColumnType("datetime");
                ...
                entity.Property(e => e.ToJourneyDate)
                    .HasColumnName("ToJourney_Date")
                    .HasColumnType("datetime");
            });
